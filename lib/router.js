...
Router.configure({
  ...
  waitOn: function() {
//
    return  [Meteor.subscribe("usuarioEventos"),Meteor.subscribe("telefones"),Meteor.subscribe("eventoCircuitos"),Meteor.subscribe("historicoEventos"),Meteor.subscribe("files"),Meteor.subscribe("consideracoes"), Meteor.subscribe("noticias"), Meteor.subscribe("incidentes"),Meteor.subscribe("solicitacoes"),  Meteor.subscribe("locais"), Meteor.subscribe("acoesOrgao"), Meteor.subscribe("users"),Meteor.subscribe("respostas"),Meteor.subscribe("imagens"),Meteor.subscribe("cameras"),Meteor.subscribe("eventos"),Meteor.subscribe("orgaos"),Meteor.subscribe("grupos"),Meteor.subscribe("circuitos"),Meteor.subscribe("trechos")]
  }
