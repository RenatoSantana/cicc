...
this.route('produtividade_ed', {
 ...
 this.route('relatorio_produtividade_consolidado', {
          path: '/relatorio_produtividade_consolidado/',
          template: 'relatorio_produtividade_consolidado',
          layoutTemplate: 'baseLayout',

          yieldTemplates: {

              'relatorio_produtividade_consolidado': {to: 'mainContent'},
