Template.produtividade_orgao.rendered = function() {
// select2
 if ($.fn.select2) {
...
criarTabelaProdutividade = function(){ var data = [
  ["", "14/09/2015", "15/09/2015", "16/09/2015", "17/09/2015"],
...
var container = document.getElementById('tabelaProdutivade');
...
greenRenderer = function(instance, td, row, col, prop, value, cellProperties) {
  Handsontable.renderers.TextRenderer.apply(this, arguments);
  td.style.backgroundColor = '#CFF3D6'; //#FFD2D2
   //td.style.backgroundColor = '#FFD2D2'
